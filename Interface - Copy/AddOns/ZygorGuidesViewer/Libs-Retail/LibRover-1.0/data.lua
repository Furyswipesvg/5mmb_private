...
data.version={
	nodes_version = 510,  -- Increase this when working on the nodes. Connections will be baked automatically when committing.
}
...
["The Timeways"] = {[0]=9001,c=1978, instance=2678  }, -- faked map based on instance
