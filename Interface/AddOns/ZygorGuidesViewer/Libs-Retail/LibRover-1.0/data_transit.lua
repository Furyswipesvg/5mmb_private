...
---------------------
	...
	--## ALLIANCE ##--
		...
		"Amirdrassil/0 51.40,18.35 -to- Feralas/0 45.14,41.73 {fac:A} {mode:PORTAL} {title:Click the Portal to Feathermoon Stronghold} ",
			...
			"Feralas/0 44.91,42.74 -to- Amirdrassil/0 54.92,63.88 {fac:A} {mode:PORTAL} {title:Click the Portal to Bel'ameth} ",

		"Amirdrassil/0 55.49,63.66 -to- Stormwind City/0 46.37,90.28 {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind} ",

			"Stormwind City/0 44.91,42.74 -to- Amirdrassil/0 54.92,63.88 {fac:A} {mode:PORTAL} {title:Click the Portal to Bel'ameth} ",
		...
		"Amirdrassil/0 55.44,64.58 -to- Darkshore/0 53.62,18.77 {fac:A} {mode:PORTAL} {title:Click the Portal to Darkshore Inside the Building} ",
			...
			"Darkshore/0 53.70,18.71 -to- Amirdrassil/0 54.92,63.88 {fac:A} {mode:PORTAL} {title:Click the Portal to Bel'ameth} ",
		...
		"Amirdrassil/0 55.41,64.90 -to- Mount Hyjal/0 63.49,23.37 {fac:A} {mode:PORTAL} {title:Click the Portal to Mount Hyjal Inside the Building} ",
			...
			"Mount Hyjal/0 62.44,22.72 -to- Amirdrassil/0 54.92,63.88 {fac:A} {mode:PORTAL} {title:Click the Portal to Bel'ameth} ",
		...
		"Amirdrassil/0 55.18,64.86 -to- Val'sharah/0 54.84,72.96 {fac:A} {mode:PORTAL} {title:Click the Portal to Val'sharah Inside the Building} ",
			...
			"Val'sharah/0 54.85,71.85 -to- Amirdrassil/0 54.92,63.88 {fac:A} {mode:PORTAL} {title:Click the Portal to Bel'ameth} ",
	...
	--## Neutral ##--
		...
		"Valdrakken/0 53.57,55.35 -to- The Timeways/0 0.00,0.00 {mode:PORTAL} {title:Click the Portal to\nThe Timeways} {cond:PlayerLevel() >= 70}",

		-- The Timeways -to- Valdrakken
		"The Timeways/0 0.00,0.00 -to- Valdrakken/0 53.57,55.35 {mode:PORTAL} {title:Click the Portal to Valdrakken\nnear the big gate} {cond:PlayerLevel() >= 70}",




		-- The Timeways -to- Vashj'ir
		"The Timeways/0 0.00,0.00 -to- Abyssal Depths/0 69.80,34.23 {mode:PORTAL} {title:Click the Portal to Vashj'ir\non the north side} {cond:PlayerLevel() >= 70}",

		-- The Timeways -to- Gorgrond
		"The Timeways/0 0.00,0.00 -to- Gorgrond/0 57.90,34.50 {mode:PORTAL} {title:Click the Portal to Gorgrond\non the northeast side} {cond:PlayerLevel() >= 70}",

		-- The Timeways -to- Val'sharah
		"The Timeways/0 0.00,0.00 -to- Val'sharah/0 55.00,72.61 {mode:PORTAL} {title:Click the Portal to Val'sharah\non the east side} {cond:PlayerLevel() >= 70}",

		-- The Timeways -to- Zuldazar
		"The Timeways/0 0.00,0.00 -to- Zuldazar/0 48.56,37.35 {mode:PORTAL} {title:Click the Portal to Zuldazar\non the southeast side} {cond:PlayerLevel() >= 70}",

		-- The Timeways -to- Drustvar
		"The Timeways/0 0.00,0.00 -to- Drustvar/0 36.90,41.06 {mode:PORTAL} {title:Click the Portal to Drustvar\non the south side} {cond:PlayerLevel() >= 70}",
